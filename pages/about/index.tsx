    ...
    <Grid container spacing={4}>
      ...
      <Grid item xs={12}>
        <Typography variant="body1">
          ...
          long as the end result is open source. Stuck on a Github Issue for an
          npm package you're using? We could fix it for you. Have an idea for a
          sweet new public tool? We could build it for you. The possibilities
          are endless as long as we could ensure that the output is open for
          everyone.
        </Typography>
      </Grid>
      <Grid item xs={12}>
